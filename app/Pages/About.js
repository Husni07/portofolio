        ...
        <div className="flex overflow-hidden flex-col-reverse items-center md:flex-row md:justify-between md:space-y-0">
          <div className="mt-8 flex flex-col justify-center space-y-4 md:mt-0 md:w-2/3">
            ...
            <p className="text-md text-lg text-gray-300 will-change-transform">
              My full name is <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pinkMe"> Moh. Husni Mubarrok</span>, I&apos;m a web developer from Rembang, Indonesia. Work in Web
              ...
              programming. and now I&apos;m learning new things (Rust, Go, Solidity, Web3
              and backend technologies).
            </p>
          </div>
          <div className="rotasigambar relative h-52 w-52 xl:h-64 xl:w-64 overflow-hidden rounded-full will-change-transform">
            <Image
